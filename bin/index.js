...
var colors, html_tag, package_info, qiniu_bucket, qiniu_command_options, qiniu_commands, qiniu_config, qiniu_default_key_prefix, qiniu_prefix, qiniu_style_seperator, root_path;
...
hexo.extend.console.register('qiniu', package_info.description, qiniu_command_options, function(args, callback) {
  var opt;
  console.log('\n'.yellow);
  ...
  switch (opt) {
    case 'info':
      return qiniu_commands.show_info();
    default:
